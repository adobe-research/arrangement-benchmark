...
message(STATUS "Third-party (external): creating target 'indirect_predicates::indirect_predicates'")

include(CPM)
CPMAddPackage(
    NAME indirect_predicates
    GITHUB_REPOSITORY MarcoAttene/Indirect_Predicates
...
elseif (${CMAKE_CXX_COMPILER_ID} MATCHES "Clang")
    ...
    target_compile_options(indirect_predicates INTERFACE "-O0"
        "-Wno-format-security" "-Wno-unknown-pragmas" "-Wno-return-type" "-Wno-macro-redefined"
    )
endif()
